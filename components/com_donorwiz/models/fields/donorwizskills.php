 ...
 */
class JFormFieldDonorwizskills extends JFormField
{
	/**
	 * The form field type.
	 *
	...
	protected function getInput()
	{
		...
		$no_option -> class = 'FIELD_SKILLS_EMPTY';
	...
	protected function getOptions()
	{
		...
		$categories_row->load(array('fieldcode'=>'FIELD_SKILLS'));
		
		if(!$categories_row->options)
			return false;
		
		$this->ngo_skills=explode("\n",$categories_row->options); 

		$options = array();

		foreach ($this->ngo_skills as $option)
		{
