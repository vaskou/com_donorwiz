...
<div class="uk-grid" data-uk-grid-margin>
	...
	<hr class="uk-article-divider">
			...
			<div class="uk-thumbnail uk-margin">
				...
				<div class="uk-thumbnail-caption"><?php echo $name;?></div>
			</div>
			...
			<div class="uk-form-row uk-grid uk-margin" >
				<div class="uk-width-1-1">
					<div class="uk-form-icon uk-width-1-1">
						...
						<input type="submit" name="Submit" class="uk-button uk-button-primary uk-button-large uk-width-1-1 " value="<?php echo JText::_('JLOGOUT'); ?>"/>
					</div>
				</div>
			</div>
