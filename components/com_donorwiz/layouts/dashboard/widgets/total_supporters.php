...
<div class="uk-panel uk-panel-box uk-panel-box-donations">
	...
	<div class="uk-grid">
		...
		<div class="uk-width-1-1 uk-text-right uk-margin-small-top">
			<a href="<?php echo JRoute::_('index.php?Itemid='. JFactory::getApplication()->getMenu()->getItems( 'link', 'index.php?option=com_donorwiz&view=dashboard&layout=dwopportunitiesresponses', true )->id );?>" class="uk-text-contrast">
